            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="divide-y divide-gray-200">
                {sortedProducts.map((p) => (
                  <tr
                    key={p.id}
                    className={`${getStatusClasses(p)} transition-colors hover:bg-opacity-50`}
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <span
                        className={`px-2.5 py-1 rounded-full text-xs ${p.mennyiseg < 10 ? "bg-red-200 text-red-800" : "bg-gray-100"}`}
                      >
                        {p.mennyiseg} db
                      </span>
                    </td>
