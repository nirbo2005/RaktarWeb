    ...
    <nav className="bg-white dark:bg-black border-b border-slate-200 dark:border-slate-800 sticky top-0 z-[100] shadow-sm transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-2 md:gap-4">
          ...
          {/* Search Bar - Csak belépve látszik */}
          {user && (
              ...
              {user ? (
                <>
                  ...
                  <button
                    ...
                    className="p-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-500 hover:text-red-500 dark:hover:text-red-400 transition-all active:scale-95"
                    title="Kilépés"
                  >🚪</button>
                </>
              ) : (
