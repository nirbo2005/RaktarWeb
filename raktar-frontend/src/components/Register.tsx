  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center p-4 transition-colors duration-500">
      <div className="bg-white dark:bg-slate-900/80 p-8 rounded-[2rem] shadow-2xl w-full max-w-md border border-gray-100 dark:border-slate-800 backdrop-blur-xl">
        ...
        {error && (
          <div className="bg-red-500/10 border border-red-500/20 rounded-xl py-3 mb-4 text-center px-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 gap-4">
            ...
            <div>
              <label className={labelStyle}>Telefonszám</label>
              <input
                type="text"
                className={inputStyle}
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 hover:bg-blue-500 text-white font-black py-4 rounded-2xl transition-all shadow-lg shadow-blue-600/20 active:scale-95 uppercase tracking-widest text-xs mt-2"
          >
            Regisztráció
          </button>
        </form>
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 dark:border-slate-800 text-center">
          <p className="text-gray-500 dark:text-slate-400 text-xs font-bold uppercase tracking-widest mb-3">
            Már van fiókod?
          </p>
          <Link
            to="/login"
