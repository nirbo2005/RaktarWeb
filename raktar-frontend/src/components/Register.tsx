...
import { register } from "../services/api"; // Importáljuk az api függvényt
...
function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("Hiba a regisztráció során. Lehet, hogy már létezik ez a felhasználónév?");
    }
  };
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center">
      <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md border border-gray-100">
        <h1 className="text-2xl font-bold text-gray-800 mb-6 text-center">Fiók létrehozása</h1>
