import { Controller, Get, Patch, Delete, Param, UseGuards, Request, ParseIntPipe, BadRequestException } from '@nestjs/common';
...
export class NotificationController {
  ...
  private getUserId(req: any): number {
    ...
    if (isNaN(parsedId)) {
      throw new BadRequestException('Nem azonosítható felhasználó (Notification)');
    }
    return parsedId;
  }
  ...
  deleteRead(@Request() req: any) {
    return this.notificationService.deleteReadNotifications(this.getUserId(req));
  }
}
